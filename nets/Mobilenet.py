...
def MobileNetv2_tiny(input_shape, k, alpha=1.0):
    ...
    x = _inverted_residual_block(x, 16, (3, 3), t=1, alpha=alpha, strides=1, n=1)
    x = _inverted_residual_block(x, 24, (3, 3), t=6, alpha=alpha, strides=1, n=2)
    # stage 1 : 16 x 16
    x = _inverted_residual_block(x, 32, (3, 3), t=6, alpha=alpha, strides=2, n=2)
    x = _inverted_residual_block(x, 64, (3, 3), t=6, alpha=alpha, strides=1, n=2)
    # stage 2 : 8 x 8
    x = _inverted_residual_block(x, 96, (3, 3), t=6, alpha=alpha, strides=1, n=1)
    x = _inverted_residual_block(x, 160, (3, 3), t=6, alpha=alpha, strides=2, n=1)
    x = _inverted_residual_block(x, 320, (3, 3), t=6, alpha=alpha, strides=1, n=1)
...
if __name__ == '__main__':
    model = MobileNetv2_tiny((32, 32, 3), 100, 1.0)
    model.summary()
    plot_model(model, to_file='MobileNetv2_tiny.png', show_shapes=True)
